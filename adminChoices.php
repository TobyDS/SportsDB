...
<head>
  <meta charset="UTF-8">
  <title>Admin Choices Editor</title>
...
<body>
  <nav class="navbar navbar-expand-sm navbar-dark" style="background-color:#606060">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item px-3">
        <a class="nav-link" style="background-color: black; color:white; font-weight: bold" href="adminChoices.php">Choices</a>
      </li>
      <li class="nav-item px-3">
  ...
  <div class="col-md-12 pt-5">
    <h1 style="font: Helvetica; font-weight: normal; font-size: 230%">Choices Editor</h1>
    <hr>
