...
print_r($_SESSION); // For testing puporses
...
<head>
  <meta charset="UTF-8">
  <title>SportsDB Admin Page</title>
...
<body>
  ...
  <div class="col-md-12 pt-5">
    ...
    <div class="container">
      <div class="col-md-8 border rounded text-center mx-auto py-3">
        <h4 class="pt-2 pb-3 text-left">Select button for assets you wish to edit:</h3>
        <form action='adminRedirect.php' method='post'>
          <div class='btn-group' role='group'>
            <button class='btn btn-secondary' name='submit' value='0'>Sports</button>
            <button class='btn btn-secondary' name='submit' value='1'>Options</button>
            <button class='btn btn-secondary' name='submit' value='2'>Students</button>
            <button class='btn btn-secondary' name='submit' value='3'>Choices</button>
            <button class='btn btn-secondary' name='submit' value='4'>Years</button>
          </div>
        </form>
      </div>
    </div>
